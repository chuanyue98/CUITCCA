...
from handlers.llama_handler import compose_graph_chat_egine, get_history_msg, indexes, compose_graph_query_engine, \
    format_source_nodes_list, token_counter
...
async def query_graph(query: str = Form()):
    last_token_count = token_counter.total_llm_token_count
    ...
    customer_logger.info("Embedding Tokens: %s", token_counter.total_embedding_token_count)
    customer_logger.info("LLM Prompt Tokens: %s", token_counter.prompt_llm_token_count)
    customer_logger.info("LLM Completion Tokens: %s", token_counter.completion_llm_token_count)
    customer_logger.info("Single LLM Token Count: %s", token_counter.total_llm_token_count-last_token_count)
    customer_logger.info("Total LLM Token Count: %s", token_counter.total_llm_token_count)
